...
| **Vehicle Security + ETL** | 1000+ CAN msg/sec · 99.7% attack detection · sub-100ms anomaly | Python · Kafka · MongoDB · scikit-learn |
| **Split Payment System** | ACID-compliant ledger, 70% fewer reconciliation errors | Java · Spring Boot · PostgreSQL |
| **Badminton Academy** | Full-stack platform serving 200+ active students | Spring Boot · Angular · MySQL · S3 |
